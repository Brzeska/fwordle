...
#read in data
data = open('train.txt').read().split('\n.....\n')
dev = open('dev.txt').read().split('\n.....\n')
...
block_size = 6
embedding_dimension = int(sys.argv[1])#10
hidden_neurons = int(sys.argv[2])#120
batch_size = 35
iterations = int(sys.argv[3])#30000
